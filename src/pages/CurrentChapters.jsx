...
//
// Standalone "who's already registered" directory page — separate from
// /create-chapter (the registration form). Reached via the Chapter dropdown
// in the nav. Reuses CreateChapter.css since the class names (.chapter-directory,
// .chapter-directory-grid, etc.) already exist there.
